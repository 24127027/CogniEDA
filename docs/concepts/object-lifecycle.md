...
This page is retained for link compatibility. Canonical scientific lifecycle
ownership now belongs to the [Scientific lifecycle](scientific-lifecycle/index.md),
with concise state and outcome lookup in the
