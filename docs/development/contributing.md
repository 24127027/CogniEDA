...
3. Check [Current state](../status/current-state.md) and
   [Limitations and bottlenecks](../status/limitations-and-bottlenecks.md).
...
3. Update the status track when verified implementation drift is found.
