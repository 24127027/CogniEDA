...
class ObjectiveRepository:
    ...
    def get_active(self) -> Objective | None:
        """Return the most recently updated active Objective, excluding history."""

        objectives = self.list(status=ObjectiveStatus.ACTIVE)
    ...
    def update(
        ...
        """Apply an explicit wording or lifecycle update to a stable Objective identity."""
